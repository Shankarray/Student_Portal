 ...
 session_start();
  if(isset($_SESSION['uid']))
  {
    ...
    <script type="text/javascript">
      window.open('loggedin.php','_self');
    </script>
    <?php
  }
?>
...
<div class="header">
        ...
        <div class="content">
                <div class="head-text">
                        <h1 align="center">Student Login Portal<br></h1>
                        <form method="post" action="login.php" name="form">
                                ...
                                <tr>
                                    ...
                                    <td><input type="password" size=30 placeholder="Type Password" name="pwd" required="required" id="area3"></td>
                                </tr>
                                <tr>
                                  
                                  <td colspan="2" align="center"><input type="submit" name="login_student" value="Login" id="login"></td>
                        </tr>
                        <tr>
                          <td colspan="2" align="center"><a href="forgotpassword.php" style="color: #81D86A;">Forgot Password ?</a></td>
                        </tr>
                         <tr>
                          <td colspan="2" align="center"><a href="register.php" style="color: #81D86A;">Sign up ?</a></td>
                        </tr>
                        <tr>
                          <td colspan="2" align="center"><a href="admin/admin_login.php" style="color: #81D86A;" >Switch to Admin</a></td>
                        </tr>
...
if(isset($_POST['login_student']))
{
  ...
  $qry = "SELECT * FROM `personal_details` WHERE `username`='$username' AND `password`='$password' AND `activate`=1;";
  ...
  else
  {
    ...
    ?>
            <script>
                window.open('profile.php?sid=<?php echo $id;?>','_self');
            </script>
            <?php
